...
//           scrolled ? "fixed top-0 shadow-xl" : "relative"
//         }`}
//       >
//         {!scrolled && (
//           <div className="bg-primary text-white">
//             <div className="w-full flex justify-between items-center py-2 px-2 sm:px-3 lg:px-4">
...
//                 <Link to="/track-order" className="hover:text-orange-100">
//                   Track Order
//                 </Link>
...
//           <div className="w-full flex items-center justify-between h-16 px-5 sm:px-6 lg:px-8 xl:px-10 gap-2">
//           {/* <div className="w-full flex items-center justify-between h-16 px-2 sm:px-3 lg:px-4 gap-1"> */}
...
//                     <div className="absolute top-full left-1/2 -translate-x-1/2 w-full max-w-5xl bg-white shadow-2xl border border-gray-100 rounded-b-xl overflow-hidden z-50">
//                       <div className="p-5">
...
//                           {link.dropdownContent?.featuredImage?.url && (
...
//                         Welcome{" "}
//                         {activeCustomer?.name?.split(" ")[0] || "User"}!
//                       </p>
...
//                     e.preventDefault();
//                     openLoginModal({
//                       from: { pathname: "/profile", search: "?tab=wishlist" },
//                     });
//                   }
//                 }}
...
//                             type="button"
//                             onClick={() =>
//                               handleDropdownClick({ path: link.path })
//                             }
...
//                           {link.dropdownContent?.columns.map((column) => (
//                             <div key={column.title}>
//                               <button
//                                 type="button"
//                                 onClick={() =>
//                                   setMobileSubDropdown(
//                                     mobileSubDropdown === column.title
//                                       ? null
//                                       : column.title
//                                   )
//                                 }
...
//                                       })
//                                     }
//                                     className="block w-full text-left py-1.5 text-sm text-primary"
//                                   >
//                                     All {column.title}
//                                   </button>
...
//                       Welcome, {activeCustomer?.name?.split(" ")[0]}
//                     </p>
