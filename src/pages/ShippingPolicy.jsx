...
const ShippingPolicy = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      try {
        const res = await getContentPage("shipping-policy");
        setData(res || {});
      } catch (error) {
        console.error("Shipping Policy fetch error:", error);
      }
    };
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-4 py-10 md:py-12">
          ...
          <div className="text-center">
            ...
            <p className="text-cream/70 text-base max-w-2xl mx-auto mt-3">
              Everything you need to know about order shipping and delivery.
            </p>
          </div>
        </div>
      </section>
