...
//                   return (
//                     <div key={item.cartItemId || item.id} className="bg-white rounded-xl shadow-sm border border-stone-100 p-4 md:p-5 hover:shadow-md transition-all">
//                       <div className="flex flex-col sm:flex-row gap-4">
//                         <div className="relative w-full sm:w-28 h-32 flex-shrink-0">
//                           <img 
//                             src={item.image} 
...
//                               {item.color && (
//                                 <p className="text-xs text-stone-500 mt-1">Color: {item.color}</p>
//                               )}

//                               {item.material && (
//                                 <p className="text-xs text-stone-500 mt-1">Material: {item.material}</p>
//                               )}
//                             </div>
//                             <div className="text-right">
...
//                               <div className="flex items-center border border-stone-200 rounded-lg bg-white">
//                                 <button 
//                                   onClick={() => updateQuantity(item.cartItemId || item.id, Math.max(1, item.qty - 1))}
...
//                                 <button 
//                                   onClick={() => updateQuantity(item.cartItemId || item.id, item.qty + 1)}
